...
1. Explain the difference between `RDBMS` and `SQL`.
    ...
    RDBMS is a database management system that is used to organize, update, and retrieve data in a database using tabs consisting of tables/rows and columns.  SQL is the language used to manage the databases  and is supported by most RDBMS.

2. Why do tables need a `primary key`?

    A primary key is needed to identify individual items within a database.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    ...
    A third table is needed for a many to many relationship.
